...
class Evictor extends React.Component {
  ...
  render() {
    const imageURL = this.props.data.photo
      ? this.props.data.photo.sizes.src
      : evictorPlaceholder;
    const style = {
    ...
    return (
      <div
        ...
        id={
          citywide
            ? this.props.data.citywideRank
            : this.props.boroName + this.props.data.rank
        }
      >
        <div className="columns">
          <div className="column col-2 col-sm-4 evictor-rank">
            <div>
              <h1
                className={
                  citywide && this.props.data.citywideRank > 9
                    ? "double-digit"
                    : ""
                }
              >
          ...
          <div className="column col-7 col-sm-12">
            <div className="evictor-intro">
              ...
              <h6 className="evictor-corp text-dark">
                {this.props.data.corporation}
              </h6>
              <h6 className="text-gray-medium text-italic">
                Last year's rank:{" "}
                {this.props.data.rankLastYear ? (
                  <>
                    <sup>#</sup>
                    {this.props.data.rankLastYear}
                  </>
            ...
            <div className="evictor-stats">
                ...
                <div className="column col-12 rtc-data">
                  <h4 className="eviction-count">
                    <span className="text-primary">
                      {citywide
                        ? this.props.data.citywideEvictions
                        : this.props.data.evictions}
                    </span>{" "}
                    Evictions
                  </h4>
              ...
              <div className="mb-2">
                <span>
                  ...
                  <nobr className="text-gray-medium text-italic pl-1">
                    (Among Others)
                  </nobr>
                </span>
                <br />
            ...
            <div className="btn-group evictor-links">
              {!citywide &&
                this.props.data.updatedRtcEvictionsMapUrl &&
                this.props.data.updatedRtcEvictionsMapUrl
                  ...
                  <Link
                    ...
                    state={{
                      iframe: this.props.data.updatedRtcEvictionsMapUrl
                        .updatedRtcEvictionsMapUrl,
                      mapType: "rtc"
                    }}
                  >
              ...
              {citywide &&
                this.props.data.citywideEvictionsMapUrl &&
                this.props.data.citywideEvictionsMapUrl
                  ...
                  <Link
                    ...
                    className="btn btn-outline-primary my-1"
                    state={{
                      iframe: this.props.data.citywideEvictionsMapUrl
                        .citywideEvictionsMapUrl,
                      mapType: "citywide"
                    }}
                  >
            ...
            {!citywide &&
              ...
              this.props.data.description.json &&
              documentToReactComponents(
                this.props.data.description.json,
                contentfulOptions
              )}
            {citywide &&
              this.props.data.citywideListDescription &&
              this.props.data.citywideListDescription.json &&
              documentToReactComponents(
                this.props.data.citywideListDescription.json,
                contentfulOptions
              )}
            {this.props.data.organizingCta ? (
              <span className="get-involved">
                ...
                ></div>
                {documentToReactComponents(
                  this.props.data.organizingCta.json,
                  contentfulOptions
                )}
                <div className="organizing-photos">
                  {this.props.data.organizingPhoto1 ? (
                    <div>
                      <div className="img-container mb-2">
                        <img
                          src={this.props.data.organizingPhoto1.fluid.src}
                          onClick={() => this.onModalOpen(1)}
                      ...
                      <div
                        className={
                          "modal" +
                          (this.state.organizingModal === 1 ? " active" : "")
                        }
                        id="modal-id"
                      >
                        <a
                  ...
                  {this.props.data.organizingPhoto2 ? (
                    <div>
                      <div className="img-container mb-2">
                        <img
                          src={this.props.data.organizingPhoto2.fluid.src}
                          onClick={() => this.onModalOpen(2)}
                          className="img-responsive my-2"
                        />
                      </div>
                      <div
                        className={
                          "modal" +
                          (this.state.organizingModal === 2 ? " active" : "")
                        }
                        id="modal-id"
                      >
                        <a
                  ...
                  {this.props.data.organizingPhoto3 ? (
                    <div>
                      <div className="img-container mb-2">
                        <img
                          src={this.props.data.organizingPhoto3.fluid.src}
                          onClick={() => this.onModalOpen(3)}
                          className="img-responsive my-2"
                        />
                      </div>
                      <div
                        className={
                          "modal" +
                          (this.state.organizingModal === 3 ? " active" : "")
                        }
                        id="modal-id"
                      >
                        <a

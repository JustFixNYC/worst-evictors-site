...
const Layout = ({ children }: Props) => (
      <>
        <Helmet>
          <html lang="en" />
          <title>NYC's Worst Evictors</title>
          ...
          <meta name="author" content="Right to Counsel Coalition" />

          <meta property="fb:app_id" content="247990609143668" />
          <meta property="og:site_name" content="NYC's Worst Evictors" />
          <meta property="og:title" content="Is your landlord on our list and map of NYC's worst evictors? Learn your rights here!" />
          ...
          <meta name="twitter:title" content="Is your landlord on our list and map of NYC's worst evictors? Learn your rights here!" />
